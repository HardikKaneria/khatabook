...
export default function MoneyOutForm({
    ...
    const [form, setForm] = useState({
        ...
        to_account_id: defaultToAccountId || otherAccounts[0]?.id || "",
        description: "",
        reference: "",
    });
    ...
    return (
        <form className="space-y-3" onSubmit={handleSubmit}>
            ...
            <div>
                <label className="kb-muted">From Account (Bank / Cash)</label>
            ...
            <div>
                <label className="kb-muted">To Account (Expense / Vendor)</label>
